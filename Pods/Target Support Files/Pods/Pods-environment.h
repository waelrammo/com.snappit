...
// MYHelpers
#define COCOAPODS_POD_AVAILABLE_MYHelpers
#define COCOAPODS_VERSION_MAJOR_MYHelpers 1
#define COCOAPODS_VERSION_MINOR_MYHelpers 0
#define COCOAPODS_VERSION_PATCH_MYHelpers 1
